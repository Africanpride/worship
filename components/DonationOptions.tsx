					...
					<TabsTrigger
 					...
 					>
						...
						<div className="flex flex-col items-center sm:items-start text-center sm:text-left overflow-hidden">
							<span className="font-bebas text-base sm:text-lg tracking-wider uppercase leading-none truncate w-full">
								Cash
							</span>
							<span className="text-[9px] sm:text-[10px] font-bold opacity-60 uppercase tracking-[0.15em] mt-1 whitespace-nowrap">
								Contribution
							</span>
						</div>
					</TabsTrigger>
				...
				<TabsContent value="cash" className="space-y-6">
					<div className="flex flex-wrap items-center justify-between gap-3 px-1.5 mb-2">
						...
						<div className="flex items-center gap-1.5 bg-secondary/50 px-2 py-0.5 rounded-full border border-border/50">
							<span className="text-[9px] sm:text-[10px] font-bold text-emerald-500 uppercase tracking-tighter">
								🔒 256-bit SSL
							</span>
						</div>
					</div>
                  ...
                  bg-amber-500/10 px-3 py-1.5 rounded-md uppercase"
							...
							<AccordionContent className="pt-0 pb-5">
								<div className="pt-5 border-t border-border text-center">
									<p className="text-[15px]  font-opensans  text-muted-foreground leading-relaxed mb-6">
										Send your contribution securely via PayPal. You will be
						...
						>
							...
							<AccordionContent className="pt-0 pb-5">
								<div className="pt-5 border-t border-border text-center">
									<p className="text-[15px]  font-opensans  text-muted-foreground leading-relaxed mb-6">
										Support us globally using any major credit or debit card
				...
				<TabsContent value="kind" className="space-y-6">
					<div className="relative overflow-hidden p-6 rounded-2xl border border-amber-500/20 bg-amber-500/5 group">
						...
						<div className="relative z-10 flex gap-5 items-center">
							...
							<div>
								<h4 className="font-bebas text-2xl tracking-wide text-amber-600 dark:text-amber-400 mb-1">
									Sacrifice in Kind - Silver Jubilee Edition
								</h4>
								<p className="text-[15px] font-opensans text-muted-foreground leading-relaxed max-w-lg">
									Beyond financial support, we gratefully accept resources that
									fuel the hospitality, logistics, and continuous worship of
									this historic 25th Anniversary Non-Stop.
								</p>
							</div>
						</div>
					</div>
