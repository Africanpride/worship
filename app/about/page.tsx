							...
							>
								<div className="pr-2">
									...
									>
										...
										praise &amp; worship programmes. This historic 25th Year
										Silver Jubilee celebration marks a journey that began with
										24-hour sessions which progressed to 144 hours; the first
										session of which was held in 2021.
									</motion.p>
								</div>
								...
								>
									<div className="relative aspect-[0.7] w-full rounded-lg overflow-hidden md:w-1/2 min-h-[350px]">
										<motion.div
											className="size-full min-h-[350px] w-full"
