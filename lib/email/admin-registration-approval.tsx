			...
			<Tailwind>
				<Body className="bg-white text-black font-sans">
					<Container className="my-10 px-6 py-8 border rounded-md shadow-md max-w-xl">
						...
						<Text className="text-sm leading-6">Hello {adminName},</Text>

						<Text className="text-sm leading-6">
							A new applicant, <strong>{applicantName}</strong>, has registered
						...
						<Text className="text-sm leading-6">
							...
							<br />
							<strong>Edition:</strong> {editionTitle}
							<br />
						...
						<Text className="text-sm leading-6">
							Please review and approve their registration at your earliest
							convenience.
						</Text>
						...
						<Text className="text-xs text-gray-600 mt-6">
							If you need any assistance or encounter issues accessing the
							dashboard, please contact support at{" "}
							<a
