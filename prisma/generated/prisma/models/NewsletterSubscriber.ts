...
export type NewsletterSubscriberWhereInput = {
  ...
  notifyPermission?: Prisma.BoolFilter<"NewsletterSubscriber"> | boolean
  verified?: Prisma.BoolFilter<"NewsletterSubscriber"> | boolean
  unsubscribeToken?: Prisma.StringNullableFilter<"NewsletterSubscriber"> | string | null
  confirmationToken?: Prisma.StringNullableFilter<"NewsletterSubscriber"> | string | null
  topics?: Prisma.StringNullableListFilter<"NewsletterSubscriber">
  ...
  locale?: Prisma.StringNullableFilter<"NewsletterSubscriber"> | string | null
...
export type NewsletterSubscriberOrderByWithRelationInput = {
  ...
  notifyPermission?: Prisma.SortOrder
...
export type NewsletterSubscriberScalarWhereWithAggregatesInput = {
  ...
  notifyPermission?: Prisma.BoolWithAggregatesFilter<"NewsletterSubscriber"> | boolean
  verified?: Prisma.BoolWithAggregatesFilter<"NewsletterSubscriber"> | boolean
  unsubscribeToken?: Prisma.StringNullableWithAggregatesFilter<"NewsletterSubscriber"> | string | null
  confirmationToken?: Prisma.StringNullableWithAggregatesFilter<"NewsletterSubscriber"> | string | null
  topics?: Prisma.StringNullableListFilter<"NewsletterSubscriber">
  ...
  locale?: Prisma.StringNullableWithAggregatesFilter<"NewsletterSubscriber"> | string | null
}
...
export type NewsletterSubscriberCreateInput = {
  ...
  unsubscribeToken?: string | null
  confirmationToken?: string | null
  topics?: Prisma.NewsletterSubscriberCreatetopicsInput | string[]
...
export type NewsletterSubscriberUpdateInput = {
  ...
  notifyPermission?: Prisma.BoolFieldUpdateOperationsInput | boolean
  ...
  topics?: Prisma.NewsletterSubscriberUpdatetopicsInput | string[]
...
export type NewsletterSubscriberCreatetopicsInput = {
  set: string[]
}

export type NewsletterSubscriberUpdatetopicsInput = {
  set?: string[]
  push?: string | string[]
}
...
export type NewsletterSubscriberOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "email" | "name" | "userId" | "notifyPermission" | "verified" | "unsubscribeToken" | "confirmationToken" | "topics" | "subscribedAt" | "unsubscribedAt" | "updatedAt" | "source" | "ipAddress" | "locale", ExtArgs["result"]["newsletterSubscriber"]>
...
export interface NewsletterSubscriberDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  /**
   * Find zero or more NewsletterSubscribers that matches the filter.
   * @param {NewsletterSubscriberFindRawArgs} args - Select which filters you would like to apply.
   * @example
   * const newsletterSubscriber = await prisma.newsletterSubscriber.findRaw({
   *   filter: { age: { $gt: 25 } }
   * })
   */
  findRaw(args?: Prisma.NewsletterSubscriberFindRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>

  /**
   * Perform aggregation operations on a NewsletterSubscriber.
   * @param {NewsletterSubscriberAggregateRawArgs} args - Select which aggregations you would like to apply.
   * @example
   * const newsletterSubscriber = await prisma.newsletterSubscriber.aggregateRaw({
   *   pipeline: [
   ...
   * })
   */
  aggregateRaw(args?: Prisma.NewsletterSubscriberAggregateRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>
...
export interface NewsletterSubscriberFieldRefs {
  ...
  readonly notifyPermission: Prisma.FieldRef<"NewsletterSubscriber", 'Boolean'>
  readonly verified: Prisma.FieldRef<"NewsletterSubscriber", 'Boolean'>
  readonly unsubscribeToken: Prisma.FieldRef<"NewsletterSubscriber", 'String'>
  readonly confirmationToken: Prisma.FieldRef<"NewsletterSubscriber", 'String'>
  readonly topics: Prisma.FieldRef<"NewsletterSubscriber", 'String[]'>
...
/**
 * NewsletterSubscriber findRaw
 */
export type NewsletterSubscriberFindRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
...
/**
 * NewsletterSubscriber aggregateRaw
 */
export type NewsletterSubscriberAggregateRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
